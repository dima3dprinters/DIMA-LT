...
static void lcd_prepare_menu()
{
    ...
    MENU_ITEM(gcode, MSG_CHANGE_FILAMENT, PSTR("M104 T0 S250"));
    MENU_ITEM(function, MSG_PREHEAT_PLA, lcd_preheat_pla);
    MENU_ITEM(function, MSG_PREHEAT_ABS, lcd_preheat_abs);
    MENU_ITEM(gcode, MSG_PREHEAT_FLEX, PSTR("M104 T0 S220, M140 S65"));
    MENU_ITEM(gcode, MSG_PREHEAT_HIPS, PSTR("M104 T0 S245, M140 S100"));
    MENU_ITEM(gcode, MSG_PREHEAT_PET, PSTR("M104 T0 S210, M140 S70"));
